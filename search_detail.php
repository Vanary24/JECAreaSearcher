                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="d-flex flex-column align-items-center" id="tag">
        ...
        <script>
            ...
            $(function() {
                ...
                $('#add').on('click', function() {
                    const input = $('<input>').attr('type', 'text').attr('name', 'store_tag[]').addClass('form-control mt-2');
                    $('#tag').append(input);
                    count++;

                    if (count >= 3) {
                        $('.tag-add').css('visibility', 'hidden');
                    }
                });
            })
        </script>
