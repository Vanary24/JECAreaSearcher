...
$imgs = ["images/google map.svg", "images/house.svg", "images/shop.png", "images/ルーレット.svg"];
?>
    ...
    <div class="container mt-3">
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="m-1 p-2">
                    <h3>店舗名</h3>
                    <p class="d-flex justify-content-between align-items-center mt-4 fs-5">
                        <span class="me-1">
                            住　　所：
                        </span>
                ...
                <form action="" method="post">
                    <div class="d-flex justify-content-around align-items-center">
                        ...
                        <div>
                            <?php if (in_array($store_id, $favo_list)) { ?>
                        ...
                        <div>
                            <button type="submit" name="up" class="up">
                            ...
                            <button type="submit" name="down" class="down">
                ...
                <div class="mx-1 mt-4 p-2 text-primary">
                    <h5 class="mb-2">
                        ＃タグ：
                    </h5>
                    <p>
